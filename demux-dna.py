...
with open("HFWWMBGXY_n01_grads_set02_dna_digest_nextseq.fastq","r") as f1, open("unclassified.dna.r1.fastq","w") as u1, open("unclassified.dna.r2.fastq","w") as u2:
    f2 = SeqIO.parse(open("HFWWMBGXY_n02_grads_set02_dna_digest_nextseq.fastq","r"),"fastq")
